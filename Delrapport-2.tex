...
This article is written in 1986. It starts giving arguments for why some sort of rational process is required when designing software even though it is hard. It then goes into descripting what the authors thinks such a process looks like. This inculdes
1. Formulating a requirements document
2. Documentation of the module structure
3. Documentation of the module interfaces
4. Documentation of the uses hierachy
5. Documentation of the uses module internal structure
6. Writing the actual program
7. Maintaining it
